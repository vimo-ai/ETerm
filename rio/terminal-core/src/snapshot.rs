...
use crate::square::{Flags as CellFlags, Square};
...
impl GridSnapshot {
    ...
    pub fn capture<U: crate::event::EventListener>(
        cw: &crate::crosswords::Crosswords<U>,
    ) -> Self {
...
fn restore_grid_cells(
    grid: &mut crate::grid::Grid<Square>,
    rows: usize,
    cols: usize,
    cells: &[SnapshotCell],
) {
