#!/bin/bash
# build.sh - Build ClaudeMonitorKit plugin

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
PLUGIN_NAME="ClaudeMonitorKit"
BUNDLE_ID="com.eterm.claude-monitor"
...
<dict>
    ...
    <string>com.eterm.claude-monitor</string>
    ...
    <string>ClaudeMonitorKit.ClaudeMonitorPlugin</string>
</dict>
</plist>
EOF
